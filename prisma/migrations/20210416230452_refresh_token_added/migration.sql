/*
  ...
  - You are about to drop the `draftNft` table. If the table is not empty, all the data it contains will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "draftNft" DROP CONSTRAINT "draftNft_userId_fkey";
