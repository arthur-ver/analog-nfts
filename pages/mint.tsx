...
import { getFileExtension, getSignedUrl, uploadFile, uploadToImagekit, serverSideAuthCheck } from '../lib/helpers'
...
export const getServerSideProps = async ({ res, query: { userId, authToken, refreshTokenHash } }) => {
    const serverSideAuthCheckResponse = await serverSideAuthCheck(res, userId, authToken, refreshTokenHash)
    return serverSideAuthCheckResponse
}
